...
keys = [
    ...
    Key([mod], "space", lazy.spawn("rofi -show drun"), desc="Spawn a command using rofi"),
    Key([], "XF86AudioMute", lazy.spawn("amixer -q set Master toggle"), "Mute audio"),
...
layouts = [
    # layout.Columns(border_focus_stack=["#111111", "#222222"], border_width=4),
    layout.MonadTall(),
    layout.Max(),
